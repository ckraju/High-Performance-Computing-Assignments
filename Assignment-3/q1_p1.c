  ...
  for(i=0;i<rows;i++)
  {
      for(j=0; j<cols; j++)
    {
      ...
      if((x < 0 || y < 0 || x >= rows || y >= cols  ))
      {
        ...
        tmp2->red = (t1->red + t2->red + t3->red + t4->red) / 4;
        tmp2->green = (t1->green + t2->green + t3->green + t4->green) / 4;
        tmp2->blue = (t1->blue + t2->blue + t3->blue + t4->blue) / 4;
    } 
  }
  return im2;
}
