...
//This function is here only for checking the correctness
...
int check_correctness(int r,int c) // just the serial implementation
...
void show(int r,int c)//print the state of the grid
{
	int i, j;
	for (i = 0; i < r; ++i)
	{
